...
namespace mkfit {
  ...
  ITCONF_DEFINE_TYPE_NON_INTRUSIVE(mkfit::IterationConfig,
				   ...
				   /* float */ sc_drmax_fbh,
                                   /* float */ sc_dzmax_fbh,
                                   /* float */ sc_drmax_extbh,
                                   /* float */ sc_dzmax_extbh,
                                   /* float */ sc_drmax_eh,
                                   /* float */ sc_dzmax_eh,
				   /* float */ sc_drmax_extfh,
                                   /* float */ sc_dzmax_extfh,
                                   /* float */ sc_drmax_bl,
                                   /* float */ sc_dzmax_bl,
				   /* float */ sc_drmax_fbl,
                                   /* float */ sc_dzmax_fbl,
                                   /* float */ sc_drmax_extbl,
                                   /* float */ sc_dzmax_extbl,
                                   /* float */ sc_drmax_el,
                                   /* float */ sc_dzmax_el,
				   /* float */ sc_drmax_extfl,
                                   /* float */ sc_dzmax_extfl,
                                   /* float */ dc_fracSharedHits_central,
				   /* float */ dc_fracSharedHits_obarrel,
				   /* float */ dc_fracSharedHits_forwbarrel,
				   /* float */ dc_fracSharedHits_forward,
				   /* float */ dc_fracSharedHits_extforward,
                                   /* float */ dc_drth_central,
                                   /* float */ dc_drth_obarrel,
				   /* float */ dc_drth_forwbarrel,
                                   /* float */ dc_drth_forward,
				   /* float */ dc_drth_extforward,
				    /* float */ dc_fracSharedHits_hcentral,
                                   /* float */ dc_fracSharedHits_hobarrel,
                                   /* float */ dc_fracSharedHits_hforwbarrel,
                                   /* float */ dc_fracSharedHits_hforward,
                                   /* float */ dc_fracSharedHits_hextforward,
                                   /* float */ dc_drth_hcentral,
                                   /* float */ dc_drth_hobarrel,
                                   /* float */ dc_drth_hforwbarrel,
                                   /* float */ dc_drth_hforward,
                                   /* float */ dc_drth_hextforward,
