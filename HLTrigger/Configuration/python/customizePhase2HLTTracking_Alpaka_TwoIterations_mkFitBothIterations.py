...
def customizePhase2HLTMkFitInitialStepTracks(process):
    ...
    process.HLTItLocalRecoSequence = cms.Sequence(process.hltSiPhase2Clusters+process.hltSiPhase2RecHits+process.hltPhase2SiPixelClustersSoA+process.hltSiPixelClusters+process.hltSiPixelClusterShapeCache+process.hltPhase2SiPixelRecHitsSoA+process.hltSiPixelRecHits)
...
def customizePhase2hltHighPtTripletStepTracks(process):
    ...
    sequence_found = any(
    "hltHighPtTripletStepClusters" in str(path) for path in process.paths.values()
    )
    ...
    process.HLTHighPtTripletStepSequence= cms.Sequence(process.HLTHighPtTripletStepSeedingSequence+process.hltHighPtTripletStepTrackCandidatesMkFitSeeds+process.hltHighPtTripletStepTrackCandidatesMkFit+process.hltHighPtTripletStepTrackCandidates+process.hltHighPtTripletStepTracks+process.hltHighPtTripletStepTrackCutClassifier+process.hltHighPtTripletStepTrackSelectionHighPurity)
