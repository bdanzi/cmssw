...
# named sensor volume (389 groups total, see
# SimTracker/TrackerMaterialAnalysis/data/trackingMaterialGroups_ForPhaseII/v3/)
...
process.XMLIdealGeometryESSource.geomXMLFiles.extend(['SimTracker/TrackerMaterialAnalysis/data/trackingMaterialGroups_ForPhaseII/v3/trackingMaterialGroups_ForPhaseII.xml'])

# Analyze and plot the tracking material, using the fine-grained Groups list
process.load("SimTracker.TrackerMaterialAnalysis.trackingMaterialAnalyser_ForPhaseII_FineGrained_cfi")
