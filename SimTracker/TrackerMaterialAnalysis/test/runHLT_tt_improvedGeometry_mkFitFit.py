...
# with command line options: Phase2 -s L1P2GT,HLT:75e33_trackingOnly --processName=HLTX --conditions auto:phase2_realistic_T35 --geometry ExtendedRun4D121 --era Phase2C22I13M9 --eventcontent FEVTDEBUGHLT --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000 --filein file:/ceph/cms/store/user/mmasciov/HLT/Phase2L1TOutput/RelValTTbar_14TeV_CMSSW_20_0_0_pre1-PU_D121/output_Phase2_L1T_0.root '--inputCommands=keep *, drop *_hlt*_*_HLT, drop triggerTriggerFilterObjectWithRefs_l1t*_*_HLT' --procModifiers trackingMkFitFit --mc -n -1 --nThreads 16 --python_filename runHLT_tt_improvedGeometry_mkFitFit.py --no_exec
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C22I13M9_cff import Phase2C22I13M9
from Configuration.ProcessModifiers.trackingMkFitFit_cff import trackingMkFitFit

process = cms.Process('HLTX',Phase2C22I13M9,trackingMkFitFit)
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/ceph/cms/store/user/mmasciov/HLT/Phase2L1TOutput/RelValTTbar_14TeV_CMSSW_20_0_0_pre1-PU_D121/output_Phase2_L1T_0.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/ceph/cms/store/user/bdanzi/HLT/Phase2HLTOutput/RelValTTbar_14TeV_CMSSW_20_0_0_pre1-PU_D121/Phase2_L1P2GT_HLT_100evts_improvedGeometry_mkFitFit.root'),
